                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col items-center gap-3 sm:gap-4">
                                ...
                                >
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="subscribe-btn relative flex h-full w-[105px] shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-[15px] border-none bg-white font-medium text-sm sm:text-base text-black transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {!loading && (
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
